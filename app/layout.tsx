...
export const metadata: Metadata = {
  ...
  description: "A secure and efficient URL shortening service with custom IDs, analytics, and user accounts. Create and manage your shortened links with ease.",
  keywords: ["URL shortener", "link management", "custom URLs", "URL redirection"],
  ...
  openGraph: {
    ...
    description: "A secure and efficient URL shortening service with custom IDs, analytics, and user accounts.",
    type: 'website',
